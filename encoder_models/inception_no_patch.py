...
class EEGInceptionNoPatch(nn.Module):
    ...
    def __init__(
        ...
        inception_kernel_schedule: list[int] = [25, 75, 125, 175, 225],
    ...
    def encode(
        ...
        # (B, 5, 128) -> (B, 5, 128)
        embeddings = self.identity(embeddings)
